...
if((_men select 0)||(_men select 1))then{
    ...
    if (_side == 0) then {
      _weaponTypes = ["arifle_Katiba_C_F","arifle_MXC_F","srifle_LRR_SOS_F","LMG_Mk200_F"];
      _randomUniform = ["U_IG_Guerilla2_2","U_IG_Guerilla3_1","U_IG_Guerilla3_2","U_IG_Guerilla1_1"] call bis_fnc_selectRandom;

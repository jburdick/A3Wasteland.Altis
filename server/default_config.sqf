...
A3W_remoteBombStoreRadius = 20;    // Prevent players from placing remote explosives within this distance from any store (0 = disabled)
...
// Territory settings
A3W_territoryCaptureTime = 20*60;   // Time in seconds needed to capture a territory

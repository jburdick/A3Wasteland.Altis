...
[
  ...
  //Remote Base Access
  ["Acess Remote Base Management", "client\actions\BaseManegement.sqf", [], 1, false, true, ""], // , "'B_UavTerminal' in items player || 'O_UavTerminal' in items player ||'I_UavTerminal' in items player"
  //Open Player Menu

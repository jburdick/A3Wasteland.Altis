...
_setupObjects =
{
	...
	if(_vehicleName2 == _vehicleName3) then {
		_textVehSupport = format ["2 <t color='%2'>%1</t> helicopters", _vehicleName2, patrolMissionColor];
	}
	else
	{
	...
	_missionHintText = format ["A <t color='%3'>%1</t> helicopter and an escort of %2 are on the move. Take them down and collect their payload!", _vehicleName, _textVehSupport, patrolMissionColor];

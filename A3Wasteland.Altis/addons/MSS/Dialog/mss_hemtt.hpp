class mss_hemtt {
	...
	class controls {
		...
		class VehiclePic : RscPicture {
			...
			idc = -1;
			text = "\a3\soft_f_beta\Truck_01\Data\UI\map_truck_01_covered_ca.paa";
			x = 0.2; y = 0.3;
			w = 0.4; h = 0.4;
		};
		...
		class pos16but : RscButtonMenu {
			idc = -1;
			onButtonClick = "execVM 'MSS\mss_change.sqf'; closeDialog 0; CargoNumber = 16;";
			x = 0.35; y = 0.39;
			w = 0.04; h = 0.04;
		};

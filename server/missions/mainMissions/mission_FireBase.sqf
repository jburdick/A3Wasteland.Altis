...
_setupObjects =
{
	...
	[_aiGroup, _missionPos, _nbUnits, 5] call createLargeSyndikatroup;

	_missionHintText = format ["An armed <t color='%1'>Fire Base</t> containing many crates has been spotted near the marker, go capture it!", mainMissionColor]
};

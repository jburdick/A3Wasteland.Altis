...
_messages = [
	["Tanoa Wasteland", "Original Mod by AgentRev"],
	["Welcome", (name player)],
	["BLUFOR", "Units of Gendarmerie"],
	["INDEPENDENT", "Several groups of Bandits"],
	["OPFOR", "Paramilitary AI - roaming on land, water, air"],
	["CIVILIANS", "Bandit AI at over 50 missions"],

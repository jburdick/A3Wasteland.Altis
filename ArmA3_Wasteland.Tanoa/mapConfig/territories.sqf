...
[
	["TERRITORY_HEART_MARIE", "Heart of Isle Sainte Marie", 500, "RUINS"],
	["TERRITORY_CONSTRUCTIONSITE_BRIDGE", "Construction Site Bridge", 750, "INDUSTRIAL"],
	["TERRITORY_BALAVU_TRANSMITTER", "Balavu Transmitter", 500, "TRANSMITTER"],
	["TERRITORY_BLUE_PEARL_NORTH", "Blue Pearl Port North", 500, "INDUSTRIAL"],
	["TERRITORY_BLUE_PEARL_SOUTH", "Blue Pearl Port South", 500, "INDUSTRIAL"],

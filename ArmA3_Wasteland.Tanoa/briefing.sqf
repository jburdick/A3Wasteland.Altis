...
<br/>	* GriffinZS (A3W forums)
<br/>	* soulkobk (A3W forums)
<br/>
...
"Tanoa's Paradise",
"
<br/>We are running nearly 40 missions. Vanilla Wasteland has about 15. To be honest, most of them are edits of copies or mixes of existing one. Nevertheless, here is a quick list.
<br/>
<br/>Main Missions:
<br/>
<br/>Name: Vehicle Capture
<br/>Content: Original. Light armed (with Prowler etc), MBT, Helicopters, APC
<br/>
<br/>
<br/>Name: Holiday on Sky
<br/>Content: Two Cessna Race flying
<br/>
<br/>
<br/>Name: Helicopter Squadron
<br/>Content: Original Hostile Helicopters, but renamed 
<br/>
<br/>
<br/>Name: Bobcat Delivery
<br/>Content: A Bobcat will be delivered, escorted by Hunters. The clue: how to damage the Bobcat, so enemies get out - without destroying the Bobcat
<br/>
<br/>
<br/>Name: Hollywood Jetski
<br/>Content: Two Jetskis and a M-900. Mission cannot attack player
<br/>
<br/>
<br/>Name: Coastal Patrol
<br/>Content: Original 
<br/>
<br/>
<br/>Name: Armed Diving Expedition
<br/>Content: Original
<br/>
<br/>
<br/>Side Missions:
<br/>
<br/>
<br/>Name: Aircraft Wreck
<br/>Content: Original, but replaced the vehicle with a Blackfish
<br/>
<br/>
<br/>Name: Drugs n' Surf
<br/>Content: Original Drugrunner, but with a Jeep
<br/>
<br/>
<br/>Name: Radio Hideout
<br/>Content: Original Geocache, but renamed
<br/>
<br/>
<br/>Name: Hostile Helicopter
<br/>Content: Original
<br/>
<br/>
<br/>Name: Mosquito Attack
<br/>Content: Original Hostile Jet
<br/>
<br/>
<br/>Name: Crack Convoy
<br/>Content: Original MiniConvoy. When complete, crack should be dropped. It's a mess! The AI took it all by themselves
<br/>
<br/>
<br/>Name: Tropical Smugglers
<br/>Content: Original Smugglers
<br/>
<br/>
<br/>Name: Jungle Fever
<br/>Content: Original Sniper. Deep in the woods
<br/>
<br/>
<br/>Name: Sunken Supplies
<br/>Content: Original
<br/>
<br/>
<br/>Name: Supply Truck
<br/>Content: Original
<br/>
<br/>
<br/>Name: Meth Transport
<br/>Content: Original Drugrunner, but only Meth will drop and different car
<br/>
<br/>
<br/>Name: Weapon Cache
<br/>Content: Original 
<br/>
<br/>
<br/>Money Missions:
<br/>
<br/>
<br/>Name: Tropical Storm
<br/>Content: Blackfoot and several Prowlers
<br/>
<br/>
<br/>Name: Strider's Path
<br/>Content: Some Striders, escorted by a Pawnee
<br/>
<br/>
<br/>Name: Money Shipment
<br/>Content: Original 
<br/>
<br/>
<br/>Name: Sunken Treasure
<br/>Content: Original
<br/>
<br/>
<br/>Extra Missions:
...
<br/>
<br/>Name: Gravedigger
<br/>Content: Group of AI guards tombstone, mausoleum or graveyard pavement
<br/>
<br/>
<br/>Name: Tanoa Patrol
<br/>Content: Kajman, Panther and Offroader patrol
<br/>
<br/>
<br/>Name: Town Invasion
<br/>Content: Original
<br/>
<br/>
<br/>Name: Rats in Town
<br/>Content: edited Town Invasion
<br/>
<br/>
<br/>Name: Bandit Hideout
<br/>Content: edited Towninvasion
<br/>
<br/>
<br/>Name: Hunter's Rescue
<br/>Content: original Town Invasion. Hunter can be captured
<br/>
<br/>
<br/>Name: Business in Wood
<br/>Content: Group of AI guards a crate random wooden stuff - usable for base building. 
<br/>
<br/>
<br/>Special Missions:
<br/>
<br/>
<br/>Name: Tomb Raiders
<br/>Content: Group of AI guards several ancient stuff - usable for base bulding. And valuable like hell! But not sellable
<br/>
<br/>
<br/>Name: Stomper SOS
<br/>Content: Original Aircraft Wreck, but wreck and text edited 
<br/>
<br/>
<br/>Name: Enemy Outpost
<br/>Content: 5 brandnew kinds of outposts, created by soulkobk. Every outpost is worth it to be visited
<br/>
<br/>
<br/>Name: Sneak for Ghillie
<br/>Content: Group of AI guards a hostage. Near this hostage is a crate with 2 Ghillie Suites inside. The clue: when complete the mission, this crate will despawn. If hostage dies, too. So you have to leave one last AI alive, sneak to the hostage, steal the Ghillie and then finish the mission. Clue: not available at Genstore.
<br/>
<br/>
<br/>Name: High Tech Engineer
<br/>Content: Same scenery like Sneak for Ghille. But no crate. Instead: after you killed the AI, a crate will be paradropped. Inside: latest NVG with thermal. Clue: not available at Genstore.
<br/>
<br/>
<br/>Name: Falcon Breakdown
<br/>Content: original Sniper, but placed a Falcon. But without any use, yet, because 'gnomes' missing. But we're on it
<br/>
<br/>
<br/>Name: CAS Bandits
<br/>Content: A guarded K40 Ababil-3. Kill the AI and a crate will be paradropped, inside an UAV Terminal. Issue atm: player cannot connect. Because of these 'gnomes'. Again: we're on it!
<br/>
<br/>
<br/>Name: CAS Gendarmerie
<br/>Content: same as CAS Bandits, but with Greyhawk. The clue at these two missions, when problems fixed: BLUFOR players try to complete CAS Gendarmerie, while Bandits try to prevent.
<br/>And vice versa. When done, only BLUFOR players are able to connect to Greyhawk and Bandits to Ababil. So the other faction should destroy the vehicle, they cannot use. Or kill aproaching players
<br/>
<br/>
<br/>Disclaimer:
<br/>
<br/>
<br/>We're testing nearly every day new missions - add some, kick out others (if they dont work or get boring). We have many ideas, but often not the needed ability to realize them. 
<br/>But .. this way it won't be boring. Hopefully, you enjoy one of these missions the same way, we do - while playing AND creating. 
"
]];

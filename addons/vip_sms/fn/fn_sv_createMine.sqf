/*
	...
	Description: Create and initialise a mine for SMS.
	
	Parameters:
		0: String; classname of mine to create.
		1: Array; positionATL of where mine should be placed.
		2: Scalar; 0-360 direction of where mine should face.
		3: Array; vectorUp of how mine should be angled.
		4: Object; object to attach the mine to (objNull if none).

	Returns:
		Nothing.

	Example:
		["Claymore_Remote_Ammo_Scripted", getPosATL Player, getDir player, surfaceNormal (getPos player), objNull] call vip_sms_fnc_sv_createMine;
*/

...
switch (_boxType) do
{
	case "mission_USLaunchers":
	{
		...
		[
			...
			["wep", ["launch_B_Titan_short_tna_F", "launch_I_Titan_short_F", "launch_B_Titan_tna_F", "launch_O_Titan_ghex_F", "launch_RPG32_ghex_F", "launch_RPG7_F"], RANDOM_BETWEEN(2,5), RANDOM_BETWEEN(1,2)],
			...
			["bac", ["B_Kitbag_rgr", "B_Carryall_ghex_F"], RANDOM_BETWEEN(2,5)],
			["itm", [["H_HelmetB_Light_tna_F", "H_HelmetB_tna_F"], ["H_HelmetCrew_O_ghex_F", "H_HelmetB_Enh_tna_F"], "H_HelmetLeaderO_ocamo"], RANDOM_BETWEEN(1,4)],
			["itm", [["V_BandollierB_ghex_F", "V_HarnessO_ghex_F", "V_HarnessOGL_ghex_F", "V_TacChestrig_grn_F", "V_TacChestrig_cbr_F", "V_TacChestrig_oli_F"], 
			         ["V_BandollierB_ghex_F", "V_HarnessO_ghex_F", "V_HarnessOGL_ghex_F", "V_TacChestrig_grn_F", "V_TacChestrig_cbr_F", "V_TacChestrig_oli_F"], 
			         ["V_BandollierB_ghex_F", "V_HarnessO_ghex_F", "V_HarnessOGL_ghex_F", "V_TacChestrig_grn_F", "V_TacChestrig_cbr_F", "V_TacChestrig_oli_F"],
			         ["V_BandollierB_ghex_F", "V_HarnessO_ghex_F", "V_HarnessOGL_ghex_F", "V_TacChestrig_grn_F", "V_TacChestrig_cbr_F", "V_TacChestrig_oli_F"]] /* GL */, RANDOM_BETWEEN(1,4)]
		];
	};
	...
	case "mission_Main_A3snipers":
	{
		...
		[
			...
			["itm", ["optic_tws", "optic_tws_mg", "optic_ERCO_blk_F", "optic_Hamr_khk_F", "optic_SOS_khk_F"], RANDOM_ODDS(0.5)], // o shit waddup!!

/*
	...
	Description: Disarm/remote a mine from the player's perspective, then pass on the info to the server (where the real change takes place), then give the player a blank mine if it's been removed.
	...
	Example:
		[dummy] call vip_sms_fnc_cl_remove;
*/

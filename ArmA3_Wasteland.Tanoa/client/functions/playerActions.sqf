...
[
	...
	["<img image='client\icons\playerMenu.paa'/> <t color='#dbc27d'>Player Inventory</t>", "client\systems\playerMenu\init.sqf", [], -10, false], //, false, "", ""],
	...
	["<img image='client\icons\lupe.paa'/> <t color='#FFE496'>Property Spotter</t>", "addons\scripts\markOwned.sqf", [], -95,false,false,"","{_x in ['ItemGPS','B_UavTerminal','O_UavTerminal','I_UavTerminal']} count assignedItems player > 0"],
	
	// If you have a custom vehicle licence system, simply remove/comment the following action
	["<img image='client\icons\acquire.paa'/> <t color='#FFE496'>Acquire Ownership</t>", "client\actions\takeOwnership.sqf", [cursorTarget], 1, false, false, "", "alive cursorTarget && player distance cursorTarget <= (sizeOf typeOf cursorTarget / 3) max 3 && {{cursorTarget isKindOf _x} count ['LandVehicle','Ship','Air'] > 0 && {locked cursorTarget < 2 && !(cursorTarget getVariable ['objectLocked',false]) && cursorTarget getVariable ['ownerUID','0'] != getPlayerUID player}}"],

	["[0]"] call getPushPlaneAction,
	["<img image='client\icons\push.paa'/> Push", "server\functions\pushVehicle.sqf", [2.5, true], 1, false, false, "", "[2.5] call canPushVehicleOnFoot"],
	["<img image='client\icons\push.paa'/> Push", "server\functions\pushVehicle.sqf", [2.5], 1, false, false, "", "[2.5] call canPushWatercraft"],
	["<img image='client\icons\push.paa'/> Push", "server\functions\pushVehicle.sqf", [-2.5], 1, false, false, "", "[-2.5] call canPushWatercraft"],

...
A3W_spawnBeaconSpawnHeight = 1100; // Altitude in meters at which players will spawn when using spawn beacons (0 = ground/sea)
...
A3W_townMissionDelay = 1*60;     // Time in seconds between Town Missions
A3W_townMissionTimeout = 1*60;   // Time in seconds that a Town Mission will run for, unless completed
A3W_specialMissionDelay = 1*60;     // Time in seconds between Special Missions
A3W_specialMissionTimeout = 1*60;   // Time in seconds that a Special Mission will run for, unless completed
A3W_airMissionDelay = 1*60;     // Time in seconds between Air Missions
A3W_airMissionTimeout = 1*60;   // Time in seconds that a Air Mission will run for, unless completed
A3W_occupationMissionDelay = 1*60;     // Time in seconds between Occupation Missions
A3W_occupationMissionTimeout = 1*60;   // Time in seconds that a Occupation Mission will run for, unless completed
A3W_transportMissionDelay = 1*60;     // Time in seconds between Transport Missions
A3W_transportMissionTimeout = 1*60;   // Time in seconds that a Transport Mission will run for, unless completed
A3W_baseMissionDelay = 1*60;     // Time in seconds between Base Missions
A3W_baseMissionTimeout = 1*60;   // Time in seconds that a Base Mission will run for, unless completed
A3W_waterMissionDelay = 1*60;     // Time in seconds between Water Missions
A3W_waterMissionTimeout = 1*60;   // Time in seconds that a Water Mission will run for, unless completed

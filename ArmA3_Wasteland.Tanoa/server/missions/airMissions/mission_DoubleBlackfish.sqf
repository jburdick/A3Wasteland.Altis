...
// ******************************************************************************************
//	@file Name: mission_DoubleBlackfish.sqf
...
_setupObjects =
{
	...
	_missionHintText = format ["What the fuck!? 2 <t color='%3'>%1</t> have been spotted.<br/>Have you even known, these monsters could fly?!", _vehicleName, _vehicleName2, airMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Great job! The two Blackfishes went down. Save the crates near the last wreck!";
};

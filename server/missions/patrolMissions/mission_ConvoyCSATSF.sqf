...
_setupObjects =
{
	...
	_missionHintText = format ["A CSAT SF Team Driving a <t color='%2'>%1</t> transporting 2 weapon crates to an undisclosed location. Stop them!", _vehicleName, patrolMissionColor];

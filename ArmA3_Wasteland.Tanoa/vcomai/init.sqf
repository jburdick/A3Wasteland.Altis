...
//VCOM_fnc_ReactToFireSuppressed = compile preprocessFile "\VCOM_AI\VCOMAI\FSMFunctions\VCOM_fnc_ReactToFireSuppressed.sqf";
...
//VCOM_fnc_HandledHeal = compile preprocessFile "\VCOM_AI\VCOMAI\FSMFunctions\VCOM_fnc_HandledHeal.sqf";
VCOM_EraseMarkers = compile preprocessFile "VCOMAI\FSMFunctions\VCOM_Erasemarker.sqf";
//VCOM_DownedAI = compile preprocessFile "\VCOM_AI\VCOMAI\FSMFunctions\VCOM_DownedAI.sqf";

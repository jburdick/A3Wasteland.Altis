...
// ******************************************************************************************
//	@file Name: fn_setupResupplyTruck_Static.sqf
...
{
	_veh addAction ["<img image='client\icons\repair.paa'/> Resupply Vehicle", "client\functions\fn_resupplyTruck_Static.sqf", [], 51, false, true, "", "alive _target && alive objectParent _this && _this distance _target <= 20 && (isNil 'mutexScriptInProgress' || {!mutexScriptInProgress})"];

...
STR_R3F_LOG_action_heliport_drop = "drop l'objet";
STR_R3F_LOG_action_heliport_parachute = "Paradrop the object";
STR_R3F_LOG_action_heliport_drop_fait = "Objet ""%1"" largué.";
...
STR_R3F_LOG_action_selectionner_object_charge = "Charger ""%1"" dans...";
...
STR_R3F_LOG_action_decharger_movable_exceptionnel = "Une fois relâché, cet objet ne pourra plus être déplacé manuellement.<br/>Confirmez-vous l'action ?";
...
STR_R3F_LOG_joueur_dans_object = "Un joueur se trouve dans l'objet ""%1"" !";
STR_R3F_LOG_object_en_cours_transport = "L'objet ""%1"" est déjà en cours de transport !";

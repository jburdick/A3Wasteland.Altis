...
[
	...
	["Pickup Object", "addons\R3F_LOG\objet_deplacable\objectLockStateMachine.sqf", _doLock, 99, false, true, "", "R3F_LOG_objet_addAction == cursorObject && {R3F_LOG_action_deplacer_objet_valide && {Object_canLock && {[] call Object_safePos && {(!(cursorObject isKindOf 'AllVehicles') || cursorObject isKindOf 'StaticWeapon')}}}}"],
	...
	//Addon Actions
 	...
 	//["Put on Uniform","addons\scripts\BIB_EnemyUniform.sqf", [], 9, false, false, "","!alive cursorObject && cursorObject isKindOf 'Man'", 6]

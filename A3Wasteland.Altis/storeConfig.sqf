...
[
	...
	["PO-30 Orca (DAGR)", "O_Heli_Light_02_dynamicLoadout_F", 130000, "vehicle", "variant_orcaDAGR"], // Armed Ka-60, add "HIDDEN" if you don't want it, but don't remove the line!

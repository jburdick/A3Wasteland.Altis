...
_setupObjects =
{
	...
	[
		...
		[_veh7, _starts select 5, _startDirs select 6] call _createVehicle2,
		[_veh8, _starts select 5, _startDirs select 7] call _createVehicle2,
		[_veh9, _starts select 5, _startDirs select 8] call _createVehicle2,
		[_veh10, _starts select 5, _startDirs select 9] call _createVehicle2
	];

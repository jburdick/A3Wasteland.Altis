...
if((_bomber getVariable "is_dead_man") == "false") then {
	...
	_perform_deadmansswitch_release_action = _bomber addAction["<t color='#FF0000'>Release Switch</t>", "dead_mans_switch_release.sqf"];
	...
	_perform_deadmansswitch_cancel_action = _bomber addAction["<t color='#FF0000'>Reset Switch Pin</t>", "dead_mans_switch_cancel.sqf"];

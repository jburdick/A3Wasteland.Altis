...
_BLUveh = ["B_GEN_Offroad_01_gen_F"];
_OPFveh = ["O_G_Van_01_transport_F","O_Truck_02_fuel_F","O_Truck_02_transport_F","O_G_Offroad_01_armed_F","O_LSV_02_unarmed_F","O_LSV_02_armed_F","O_G_Van_01_transport_F"];
_INDveh = [];

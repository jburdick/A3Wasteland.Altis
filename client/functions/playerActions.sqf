...
[
	...
	["Put on Uniform","addons\scripts\AUSMD_putonUni.sqf",nil,6,true,true,"",' !alive cursorTarget && cursorTarget isKindOf "Man" && uniform cursorTarget != "" && player distance cursorTarget < 4 ']
];
